...
const Hourly = ({city,data,data2,setcity,currentweather,setdata,setdata2,hourlyweather,unit,setunit,fahrenheit}) => {
  ...
  return (
    ...
    <div className='h-auto sm:h-[20%] md:h-[25%] lg:h-[30%] w-[95%] px-4 py-3 md:px-4 md:px-3 lg:px-5 lg:py-4 bg-[#222d40]/60 rounded-4xl hover:h-[31%] transition-all duration-200 ease-in-out hover:w-[96%]  bg-[#222d40]/70 backdrop-blur-md border border-white/10'>
