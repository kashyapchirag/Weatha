...
const Dayforecastphone = ({data4,setdata4,dayweather,unit,setunit,fahrenheit}) => {
    const icons = {
        "01d":clear_day,
        "01n":clear_night,
        "02d":few_clouds_day,
    ...
    return (
        <div className='flex flex-col h-auto sm:hidden w-[95%] px-4 py-3 md:p-4 lg:p-5 bg-[#222d40]/60 rounded-4xl  bg-[#222d40]/70 backdrop-blur-md border border-white/10'>
            ...
            <div className='h-[95%] px-4 flex flex-col justify-around items-center gap-2'>
...
export default Dayforecastphone
