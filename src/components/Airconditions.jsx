...
const Airconditions = ({data,data2,lat,setlat,lon,setlon,data3,setdata3,airquality,unit,setunit,fahrenheit}) => {
  ...
  return (
    <div className='h-auto sm:h-[20%] md:h-[25%] lg:h-[30%] w-[95%] px-4 py-3 md:px-4 md:px-3 lg:px-5 lg:py-4 bg-[#222d40]/60 rounded-4xl hover:h-[29%] hover:w-[96%] hover:bg-[#222d40]/70 transition-all duration-200 ease-in-out bg-[#222d40]/70 backdrop-blur-md border border-white/10 flex flex-col'>
      ...
      <div className="box h-[78%] lg:px-[2rem] flex justify-around items-center gap-2 sm:gap-2 md:gap-5 lg:gap-9 overflow-x-hidden overflow-y-hidden scroll-smooth" >
                ...
                <div className="card w-[20rem] flex flex-col justify-center items-center">
                  ...
                  <div className='flex flex-col justify-center items-center'>
                    ...
                    <div className="aqi text-[0.75rem] md:text-[1rem] lg:text-[1.2rem] font-medium flex justify-center items-center">
                ...
                <div className="card w-[20rem] flex flex-col justify-center items-center">
                  ...
                  <div className='flex flex-col justify-center items-center'>
                    ...
                    <div className="aqi text-[0.75rem] md:text-[1rem] lg:text-[1.2rem] font-medium flex justify-center items-center" style={{color:colorMap[data3?.list?.[0].main?.aqi]}}>
                    ...
                    <div className="aqi text-[0.75rem] md:text-[1rem] lg:text-[1.2rem] font-medium flex justify-center items-center">
                      {unit=="c" &&
                        <>
                          ...
                          <span  className='cursor-pointer text-[0.75rem] md:text-[1rem] lg:text-[1.2rem] px-1 '>km/h</span>
                        </>
                      }
                      {unit=="F" &&
                        <>
                          {(((data?.wind?.speed * 3.6).toFixed(1))*0.621371).toFixed(1)}
                          <span  className='cursor-pointer text-[0.75rem] md:text-[1rem] lg:text-[1.2rem] px-1 '>miles/h</span>
                        </>
                      }
